...
#define FLAT_TCT_RELOC_TYPE_32_BIT	0
#define FLAT_TCT_RELOC_TYPE_HI16_BIT	1
#define FLAT_TCT_RELOC_TYPE_LO16_BIT	2

unsigned long tct_get_addr_from_rp(unsigned long *ptr,
			...
			unsigned long *persistent)
{
	...
	case FLAT_TCT_RELOC_TYPE_HI16_BIT:
...
EXPORT_SYMBOL(tct_get_addr_from_rp);
...
EXPORT_SYMBOL(tct_put_addr_at_rp);
